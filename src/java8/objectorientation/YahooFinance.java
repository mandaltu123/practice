...
public class YahooFinance {
    ...
    public static BigDecimal getPrice(final String ticker) {
        try {
            final URL url =
                    new URL("http://ichart.finance.yahoo.com/table.csv?s=" + ticker); // This yahoo api
            // does not work anymore, but you get the picture here right ?
